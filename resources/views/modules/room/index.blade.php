                ...
                <form class="row g-3" method="POST" action="@route('room.update', $edit->room_id)">
                    ...
                    <form class="row g-3" method="POST" action="@route('room.store')">
                        ...
                        <div class="col-12">
                            ...
                            <input required type="text" placeholder="Room name" name="room_name" value="{{ @$edit->room_name }}" class="form-control" id="inputNanme4">
                            @error('room_name') <span class="error text-danger">{{ $message }}</span> @enderror
                        </div>

                        <div class="col-12">
                            <label for="inputNanme4" class="form-label">Room Charge</label>
                            <input required type="number" placeholder="Room Charge" name="room_charge" value="{{ @$edit->room_charge }}" class="form-control" id="inputNanme4">
                            @error('room_charge') <span class="error text-danger">{{ $message }}</span> @enderror
                        </div>

                        <div class="col-12">
                            <label for="">Room Description</label>
                            <textarea placeholder="Room description" name="room_body" class="form-control" id="" cols="10" rows="4">{{ @$edit->room_body }}</textarea>
                        </div>
