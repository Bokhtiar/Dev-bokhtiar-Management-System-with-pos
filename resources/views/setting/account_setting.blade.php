            ...
            <div class="row">
                ...
                <div class="col-6 my-2">
                    ...
                    <input required type="email" placeholder="Email address" name="email"
                        value="{{ @$user->email }}" class="form-control" id="inputNanme4">
                </div>
                ...
                <div class="col-6 my-2">
                    <label for="inputNanme4" class="form-label">National ID <span
                            class="text-danger">*</span></label>
                ...
                <div class="col-6 my-2">
                    <label for="inputNanme4" class="form-label">Blood Group <span
                            class="text-danger">*</span></label>
